...
/** @typedef {{players: Player[], currentTurn: string, cardInHand: boolean, cardInHandValue: Card|null, lastDiscarded: Card | null, cardsInDeck: number, cardsInDrawPile: number}} UpdateRejoinStateData */
